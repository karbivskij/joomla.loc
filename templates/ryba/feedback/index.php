...
$form['form-1'] = array(
	...
	'cfg' => array(
		'charset' => 'utf-8',
		'subject' => 'Заказ обратного звонка / «MANGAL & DONER»',
		'title' => 'Заказ обратного звонка / «MANGAL & DONER»',
		'ajax' => true,
		'validate' => true,
		'from_email' => 'noreply@mangaldoner.ru',
		'from_name' => '«MANGAL & DONER»',
		'to_email' => 'info@mangaldoner.ru',
		'to_name' => '«MANGAL & DONER»',
		'geoip' => true,
		'referer' => true,
		'type' => 'html',
		'tpl' => true,
		...
		'okay' => 'Ваш отзыв успешно отправлен. Спасибо!',
...
$form['form-2'] = array(
	...
	'cfg' => array(
		'charset' => 'utf-8',
		'subject' => 'Новый отзыв / «MANGAL & DONER»',
		'title' => 'Новый отзыв / «MANGAL & DONER»',
		'ajax' => true,
		'validate' => true,
		'from_email' => 'noreply@mangaldoner.ru',
		'from_name' => '«MANGAL & DONER»',
...
$form['form-3'] = array(
	'fields' => array(
		...
		'datepicker' => array('title' => 'Дата доставки'),
		'clockpicker' => array('title' => 'Время доставки'),
		'user_addinfo' => array('title' => 'Комментарий'),
		'items' => array('title' => 'Заказ'),
		
		'user_delivery' => array('title' => 'Доставка'),
		'user_pay' => array('title' => 'Оплата'),

	),
	'cfg' => array(
		'charset' => 'utf-8',
		'subject' => 'Заказ / «MANGAL & DONER»',
		'title' => 'Заказ / «MANGAL & DONER»',
		'ajax' => true,
		'validate' => true,
		'from_email' => 'noreply@mangaldoner.ru',
		'from_name' => '«MANGAL & DONER»',
		...
		'antispam' => 'email77',
		'antispamjs' => 'address77',
		'okay' => 'Ваша заявка успешно отправлена. Спасибо!',
		'fuck' => 'Сообщение отправлено - ERROR',
		'spam' => 'Cпам робот',
		'notify' => 'color-modal-textbox',
		'usepresuf' => false
